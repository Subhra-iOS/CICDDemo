...
#ifndef FRIENDLISTDEMO_SWIFT_H
#define FRIENDLISTDEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FriendListDemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14FriendListDemo11AppDelegate")
...
SWIFT_CLASS("_TtC14FriendListDemo13SceneDelegate")
...
SWIFT_CLASS("_TtC14FriendListDemo14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(FriendListDemo)) <UITableViewDelegate>
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end

@class UITableViewCell;

@interface ViewController (SWIFT_EXTENSION(FriendListDemo)) <UITableViewDataSource>
